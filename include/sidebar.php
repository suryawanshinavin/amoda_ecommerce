<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="../pages/dashboard.php"><img src="../assets/images/logo.svg"
                alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="../pages/dashboard.php"><img src="../assets/images/logo-mini.svg"
                alt="logo" /></a>
    </div>
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="../pages/addproduct.php"> Add Products </a></li>
                    <li class="nav-item"> <a class="nav-link" href="../pages/products.php"> Product List </a></li>
                </ul>
            </div>
        </li>
        <hr class="my-0">
